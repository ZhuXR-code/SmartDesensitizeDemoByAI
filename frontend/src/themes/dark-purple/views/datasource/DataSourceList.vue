      ...
      <el-table :data="sourceList" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="name" label="数据源名称" min-width="180">
          <template #default="scope">
            <span style="color: #303133;">{{ scope.row.name }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="连接信息" min-width="300">
          <template #default="scope">
            <div v-if="scope.row.config" class="connection-info">
              ...
              <span style="color: #303133;">{{ scope.row.config.username || '***' }}</span>
              <span class="separator">@</span>
              <span style="color: #303133;">{{ scope.row.config.host }}:{{ scope.row.config.port }}</span>
              <span class="separator">/</span>
              <span style="color: #303133;">{{ scope.row.config.database }}</span>
            </div>
          </template>
        </el-table-column>
