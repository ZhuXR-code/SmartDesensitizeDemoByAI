      ...
      <el-col :span="8">
        <el-card class="connection-card">
          ...
          <el-form :model="connectionForm" label-position="top" ref="connectionFormRef">
            ...
            >
              <div>
                <div>当前使用已保存的数据源：<strong>{{ currentSourceName }}</strong> (ID: {{ currentSourceId }})</div>
                <div style="margin-top: 8px; font-size: 13px; color: #606266;">
                  💡 操作步骤：先点击「测试连接」验证数据库连通性，然后点击「加载表列表」获取表信息
                </div>
              </div>
            </el-alert>
          </el-form>
          ...
          >
            ...
            <el-table-column label="操作" width="100" fixed="right" align="center">
              <template #default="scope">
                <el-tooltip content="预览表数据" placement="top">
                  <el-button link type="primary" size="small" class="glass-btn-solid" @click="previewTableData(scope.row.name)">
        ...
        <el-card>
          ...
          <el-table :data="sourceList" style="width: 100%">
            ...
            <el-table-column label="连接信息" min-width="250">
              <template #default="scope">
                <span v-if="scope.row.config" class="connection-info-text">
            ...
            <el-table-column label="操作" width="280" fixed="right" align="center">
              <template #default="scope">
                <el-space>
                  <el-tooltip content="使用数据源" placement="top">
                    <el-button link type="primary" size="small" class="glass-btn-solid" @click="useDataSource(scope.row)">
                      <el-icon><Connection /></el-icon>
                    </el-button>
                  </el-tooltip>
                  <el-tooltip content="测试连接" placement="top">
                    <el-button link type="success" size="small" class="glass-btn-solid" @click="quickTestConnection(scope.row)" :loading="scope.row._testing">
                      <el-icon><Link /></el-icon>
                    </el-button>
                  </el-tooltip>
                  ...
                  <el-tooltip content="查看关联数据集" placement="top">
                    <el-button link type="primary" size="small" class="glass-btn-solid" @click="viewSourceDatasets(scope.row)">
    ...
    <el-dialog v-model="sourceDatasetsVisible" title="数据源关联的数据集" width="700px">
      <el-table :data="sourceDatasets" style="width: 100%">
        ...
        <el-table-column label="操作" width="100" align="center">
          <template #default="scope">
            <el-tooltip content="查看数据集" placement="top">
...
import { Link, Refresh, Download, FolderAdd, Check, Connection, Edit, Delete, Collection } from '@element-plus/icons-vue'
