  ...
  <div class="create-task">
    <el-card>
        ...
        <el-form :model="taskForm" label-width="120px">
          ...
          <el-form-item label="脱敏模式">
            ...
            <el-tooltip content="自动模式下，系统会在处理过程中为每个字段智能匹配最合适的脱敏规则" placement="top">
              <el-icon style="margin-left: 8px; cursor: help; color: rgba(239, 221, 141, 0.5);"><QuestionFilled /></el-icon>
            </el-tooltip>
          </el-form-item>
      ...
      <div v-if="activeStep === 2" style="margin-top: 20px;">
        ...
        <!-- 自动模式统计信息 -->
        <div v-if="desensitizationMode === 'auto' && autoDetectStats" class="stats-card">
