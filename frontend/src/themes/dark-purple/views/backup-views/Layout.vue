...
import { HomeFilled, Document, Search, Lock, ArrowDown, QuestionFilled, Fold, Expand, TrendCharts, UserFilled, Setting, SwitchButton } from '@element-plus/icons-vue'
...
.header-search {
  ...
  &:hover, &:focus-within {
    background: rgba(33, 1, 36, 0.7);
    border-color: rgba(244, 253, 175, 0.2);
    box-shadow: 0 4px 12px rgba(244, 253, 175, 0.1);
    width: 260px;
  }
