                ...
                <el-table-column label="操作" width="80" align="center">
                  <template #default="scope">
                    <el-tooltip content="删除映射" placement="top">
                      <el-button link type="danger" size="small" class="glass-btn-solid" @click="removeMapping(scope.$index)">
        ...
        <el-card>
          <template #header>
            <div class="card-header">
              ...
              <el-tooltip content="下载报告文件" placement="top">
                <el-button link type="primary" @click="downloadReportFile">
...
const coverageColor = (percentage) => {
  if (percentage < 50) return '#FCA5A5'
  if (percentage < 80) return '#EFDD8D'
  return '#F4FDAF'
}
...
.metric-card.accuracy {
  background: linear-gradient(135deg, rgba(101, 116, 58, 0.8) 0%, rgba(57, 79, 73, 0.8) 100%);
}

.metric-card.coverage {
  background: linear-gradient(135deg, rgba(57, 79, 73, 0.8) 0%, rgba(33, 1, 36, 0.8) 100%);
}

.metric-card.speed {
  background: linear-gradient(135deg, rgba(239, 221, 141, 0.4) 0%, rgba(244, 253, 175, 0.3) 100%);
  color: #210124;
}

.metric-card.time {
  background: linear-gradient(135deg, rgba(33, 1, 36, 0.8) 0%, rgba(57, 79, 73, 0.8) 100%);
}
