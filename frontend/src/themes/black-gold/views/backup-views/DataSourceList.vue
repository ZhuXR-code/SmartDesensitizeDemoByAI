        ...
        <el-table-column label="操作" min-width="220" fixed="right" align="right">
          <template #default="scope">
            <el-space wrap :size="4">
              <el-button link type="primary" size="small" @click="goToManage(scope.row.id)">
                使用
              </el-button>
              ...
              <el-button link type="primary" size="small" @click="viewDatasets(scope.row)">
                数据集({{ scope.row._datasetCount || 0 }})
              </el-button>
