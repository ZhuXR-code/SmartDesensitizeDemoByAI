            ...
            <el-form-item label="字段规则配置" required>
              <el-table :data="ruleMappings" border size="small" style="width: 100%;">
                ...
                <el-table-column label="操作" width="100">
                  <template #default="scope">
                    <el-button link type="danger" class="glass-btn-solid" @click="removeMapping(scope.$index)">
                      <el-icon><Delete /></el-icon>
                    </el-button>
                  </template>
                </el-table-column>
              </el-table>
              <el-button type="primary" link class="glass-btn-solid" @click="addMapping" style="margin-top: 8px;">
